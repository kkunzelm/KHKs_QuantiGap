	...
	public void mousePressed(MouseEvent e) {
            ...
            if (np > 1 && delete == false){
                ...
                if(c == Color.RED){
                    ...
                    sumOfLines[4]=sumOfLines[1]+distance(xCoord[np-1], yCoord[np-1], xCoord[np-2], yCoord[np-2]);
                }
                else if (c == Color.CYAN){
                    sumOfLines[5]=sumOfLines[2]+distance(xCoord[np-1], yCoord[np-1], xCoord[np-2], yCoord[np-2]);
                }
                else if (c == Color.GREEN){
                    sumOfLines[6]=sumOfLines[3]+distance(xCoord[np-1], yCoord[np-1], xCoord[np-2], yCoord[np-2]);
                }
                else if (c == Color.YELLOW){
                    sumOfLines[7]=sumOfLines[1]+distance(xCoord[np-1], yCoord[np-1], xCoord[np-2], yCoord[np-2]);
                }
                else if (c == Color.DARK_GRAY){
                    sumOfLines[8]=sumOfLines[2]+distance(xCoord[np-1], yCoord[np-1], xCoord[np-2], yCoord[np-2]);
                }
  ...
  */
  ...
  void allDone(){
    ...
    private void showHelp(){
         ...
         // ***
         JLabel label1 = new JLabel("<html><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#000000\">"+
