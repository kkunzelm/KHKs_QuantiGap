...
/**
 * This plugin is an extended version of Wayne Rasband's plugin for
 * ImageJ.  It allows naming of individual segments as they are measured and
 * saves the rois for repeated processing.  It is
 * customizable for processing in the DoSomethingOnThisRoi function (which
 * currently has a dummy function.
 *
...
public class Named_Measurement2 implements PlugIn, ActionListener, Measurements {
	...
	public void ShowIt() {
		...
		RunButton.setToolTipText("Click to record measurements "
				 + "and to store this ROI");
		RunButton.setBackground(new Color(45, 119, 176));
		RunButton.addActionListener(this);
		panel.add(RunButton);
		NewButton = new JButton();
		NewButton.setText("Do All Again");
		NewButton.setToolTipText("Click to analyze the active image using"
				 + " the same ROIs");
	...
	public void actionPerformed(ActionEvent e) {
		...
		segmentnames[n] = "";
		GenericDialog gd =
				new GenericDialog("Name of segment:", IJ.getInstance());
